<?php
// config.php - Configuración unificada para PostgreSQL SonoErasmus+
...
function getCurrentUser($pdo) {
    ...
    try {
        $stmt = $pdo->prepare("SELECT id, nome, cognome, email, username, foto, created_at FROM Utente WHERE id = :id");
